...
import "./Card.scss";
export default function Card({ commentModal, setCommentModal, p, shareModal, setShareModal }) {
  return (
    <div className="card">
      ...
      <SideBar commentModal={commentModal} setCommentModal={setCommentModal} shareModal={shareModal} setShareModal={setShareModal} />
    </div>
  );
}
